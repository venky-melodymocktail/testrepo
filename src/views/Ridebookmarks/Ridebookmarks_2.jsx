...
const Ridebookmarks_2 = observer(() => {
    useEffect(() => {
        const handleResize = () => {
            const bodyWidth = document.body.clientWidth
            const scale = bodyWidth / 900
            const element = document.getElementById('t18_1282_1855')
            if (element) {
                        ...
                        >
                            <select
                                ...
                                onChange={(val) => {
                                    ...
                                    dl.changes.selectedRideBookmarkType = val
...
export default Ridebookmarks_2
