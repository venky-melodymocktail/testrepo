...
const Ridesharing_1 = observer(() => {
    useEffect(() => {
        const handleResize = () => {
            const bodyWidth = document.body.clientWidth
            const scale = bodyWidth / 1440
            const element = document.getElementById('t18_822_5584')
            if (element) {
                        ...
                        >
                            <div
                                ...
                                style={{
                                    ...
                                    width: 845,
                                    borderRadius: 15,
                                    backgroundColor: 'rgba(203,202,202,0.80)',
                                    flexDirection: 'row',
                                    alignItems: 'center',
                                    justifyContent: 'center',
                                    display: 'flex',
                            ...
                            >
                                ...
                                <MaterialAutoComplete
                                    options={dl.changes.ridesZipCodeoptions}
                                    onChange={(val) => {
                                        const run = async () => {
                                            var searchtext = val
                                            if (isNaN(searchtext)) {
                            ...
                            <div
                                ...
                                style={{
                                    ...
                                    alignItems: 'center',
                                    justifyContent: 'center',
                                    display: dl.changes.rideSharingClearVisible,
                                    paddingLeft: 10,
                                    paddingRight: 10,
                                    paddingTop: 10,
                                    paddingBottom: 10,
                        ...
                        >
                            ...
                            'Wanted' ? (
                                ...
                                <MMFilter
                                    dataSource={dl.changes.rideSharingFilter}
                                    onChange={(val) => {
                                        dl.changes.rideSharingFilter = val
                                        dl.functions.applyRideSharingFilter()
                                    }}
                                />
                            )}
