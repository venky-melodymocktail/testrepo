...
const Comments_3 = observer(() => {
    ...
    useEffect(() => {
        const handleResize = () => {
            ...
            const element = document.getElementById('t18_807_4952')
            if (element) {
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        {dl.changes.addSpaces.VisaCommentsAd.sm
                            ?.slice(4, -1)
                            .trim() != '' ? (
                            <img
                                id="t18_486_217"
                                ...
                                src={dl.changes.addSpaces.VisaCommentsAd.sm
                                    ?.slice(4, -1)
                                    .trim()}
                            ></img>
                        ) : (
