...
const Moviebookmarks_3 = observer(() => {
    useEffect(() => {
        const handleResize = () => {
            const bodyWidth = document.body.clientWidth
            const scale = bodyWidth / 620
            const element = document.getElementById('t18_1278_4376')
            if (element) {
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <MmEmptyListS {...dl.changes.bookmarkNodataVisible} />
...
export default Moviebookmarks_3
