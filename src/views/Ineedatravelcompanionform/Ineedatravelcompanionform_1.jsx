...
const Ineedatravelcompanionform_1 = observer(() => {
    useEffect(() => {
        const handleResize = () => {
            const bodyWidth = document.body.clientWidth
            const scale = bodyWidth / 1440
            const element = document.getElementById('t18_1513_1560')
            if (element) {
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <MmSelect
                                    {...dl.changes.ineedatcform.bookedTicket}
                                    onChange={(val) => {
                                ...
                                <MmAutoComplete
                                    ...
                                    onSelect={(val) => {
                                        dl.changes.ineedatcform.from.value = val
                                ...
                                <MmAutoComplete
                                    ...
                                    onSelect={(val) => {
                                        dl.changes.ineedatcform.to.value = val
                                        var airportName = val.split(',')
                                        var airport = airportName[0]
                                        for (
                                            let i = 0;
                                ...
                                >
                                    <MmDatePicker
                                        {...dl.changes.ineedatcform.fromDate}
                                        onChange={(val) => {
                                ...
                                >
                                    ...
                                    >
                                        <MmSelect
                                            {...dl.changes.ineedatcform.airline}
                                            onChange={(val) => {
     ...
     {...dl.changes.ineedatcform.tip}
            ...
            onChange={(val)=>{
                ...
                if(amount>50){
                    ...
                    dl.changes.ineedatcform.tip.showErrorMessage = "flex"
                    dl.changes.ineedatcform.tip.errorMessage = "amount must be less then $50"
                    return
                }
                                    ...
                                    const run = async () => {
                                        ...
                                        var body = {
                                            ...
                                            ticketBooked:
                                                dl.changes.ineedatcform
                                                    .bookedTicket.value,
                                            from: dl.changes.ineedatcform.from
                                                .selectedAirport,
                                            ...
                                            email: dl.changes.ineedatcform.email
                                                .value,
                                            phone:
                                                dl.changes.ineedatcform.phone
                                                    .selectPlaceHolder +
...
export default Ineedatravelcompanionform_1
