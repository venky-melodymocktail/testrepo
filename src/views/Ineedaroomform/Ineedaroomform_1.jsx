...
const Ineedaroomform_1 = observer(() => {
    useEffect(() => {
        const handleResize = () => {
            const bodyWidth = document.body.clientWidth
            const scale = bodyWidth / 1440
            const element = document.getElementById('t18_1174_1049')
            if (element) {
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <MmDatePicker
                                    {...dl.changes.iNeedAroomForm.neededFrom}
                                    onChange={(val) => {
                                ...
                                <MmSelect
                                    {...dl.changes.iNeedAroomForm.noOfPeople}
                                    onChange={(val) => {
                                ...
                                <MmSelect
                                    {...dl.changes.iNeedAroomForm.attatchedBath}
                                    onChange={(val) => {
                                ...
                                <MmSelect
                                    {...dl.changes.iNeedAroomForm.furnishing}
                                    onChange={(val) => {
                                ...
                                <MmSelect
                                    {...dl.changes.iNeedAroomForm.vegPreference}
                                    onChange={(val) => {
                                ...
                                <SampleInput
                                    {...dl.changes.iNeedAroomForm.occupation}
                                    onChange={(val) => {
                                ...
                                <MmTextArea
                                    {...dl.changes.iNeedAroomForm.description}
                                    onChange={(val) => {
                                ...
                                onClick={(e) => {
                                    var run = async () => {
                                        ...
                                        if (res == true) {
                                            ...
                                            var body = {
                                                rentalType: 'Room',
                                                type: dl.changes.iNeedAroomForm
                                                    .type.value,
                                                ...
                                                languages:
                                                    dl.changes.iNeedAroomForm
                                                        .languages.value,
                                                title: dl.changes.iNeedAroomForm
                                                    .title.value,
                                                description:
                                                    dl.changes.iNeedAroomForm
                                                        .description.value,
                                                name: dl.changes.iNeedAroomForm
                                                    .name.value,
                                                email: dl.changes.iNeedAroomForm
                                                    .email.value,
                                                contactNumber:
                                                    dl.changes.iNeedAroomForm
                                                        .phone
...
export default Ineedaroomform_1
