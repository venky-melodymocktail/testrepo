...
const Ineedahomeform_1 = observer(() => {
    useEffect(() => {
        const handleResize = () => {
            const bodyWidth = document.body.clientWidth
            const scale = bodyWidth / 1440
            const element = document.getElementById('t18_1183_419')
            if (element) {
                                ...
                                onClick={(e) => {
                                    var run = async () => {
                                        ...
                                        if (res == true) {
                                            ...
                                            var body = {
                                                rentalType: 'Home',
                                                title: dl.changes.iNeedAhomeForm
                                                    .title.value,
                                                description:
                                                    dl.changes.iNeedAhomeForm
                                                        .description.value,
                                                type: dl.changes.iNeedAhomeForm
                                                    .type.value,
                                                exactAddress:
                                                    dl.changes.iNeedAhomeForm
                                                        .address.value,
                                                ...
                                                petFriendly:
                                                    dl.changes.iNeedAhomeForm
                                                        .petFriendly.value,
                                                name: dl.changes.iNeedAhomeForm
                                                    .name.value,
                                                email: dl.changes.iNeedAhomeForm
                                                    .email.value,
                                                contactNumber:
                                                    dl.changes.iNeedAhomeForm
                                                        .phone
...
export default Ineedahomeform_1
