...
const PostYourNeedRoomSModal = observer(() => {
    const [anim, setAnim] = useState('')
    const [showModal, setShowModal] = useState(
        dl.modalsStatus['PostYourNeedRoomSModal']
    )
    useEffect(() => {
        if (!dl.modalsStatus['PostYourNeedRoomSModal']) {
            closeModal()
        } else {
            setShowModal(true)
        }
    ...
    const closeModal = () => {
        setAnim('')
        setTimeout(() => {
            dl.modalsStatus['PostYourNeedRoomSModal'] = false
            setAnim('')
            setShowModal(false)
        }, 0)
    }
...
export default PostYourNeedRoomSModal
